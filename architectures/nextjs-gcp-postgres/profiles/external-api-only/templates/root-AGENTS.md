...
- This profile obtains product data from documented external APIs. It includes
  ...
  PostgreSQL service, Cloud SQL configuration, or database package dependency.
...
- Use server-side secret references and short-lived Workload Identity
  Federation for Google Cloud.
...
- Cloud Run delivery must use immutable images, least-privilege identities, and
