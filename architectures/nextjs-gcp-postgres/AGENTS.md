# Next.js GCP PostgreSQL architecture instructions

This package preserves the reviewed Next.js Turborepo, Mantine, PostgreSQL, and
Google Cloud behavior that predates architecture packages.
...
- `repo-overlay/scripts/architecture/nextjs-gcp-postgres/verify.mjs` owns Next.js,
...
Keep Google Cloud, Cloud Run, PostgreSQL, Mantine, and Next.js assumptions here,
...
the PostgreSQL CI service, Cloud SQL delivery flags, and database-specific
